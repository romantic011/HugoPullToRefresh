package cn.hugo.android.widget.pulltorefresh.lib;


import cn.hugo.android.widget.pulltorefresh.R;
import cn.hugo.android.widget.pulltorefresh.internal.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mode = a.getInteger(R.styleable.PullToRefresh_mode, MODE_PULL_DOWN_TO_REFRESH);//mode = 0x3;
